...
$(function() {
	...
	$('#fruit1').mouseover(function() {
		...
		$("#slicesound")[0].play(); // this is going to return an array and not really the html element, unless we specify the index

		//stop fruit
		clearInterval(action);

		//hide fruit
		$('#fruit1').hide("explode", 500); //slice fruit BUGS/INCOMPATIBILITY ENCOUNTERED
